...
public class Conexion {
    ...
    public Conexion() {
        try {
            ...
            // Paso 2: Establecer la conexión con la base de datos 'libros_rincondeloslibros' en localhost
            this.connection = DriverManager.getConnection(
                "jdbc:mysql://localhost:3306/libros_rincondeloslibros",  // URL de conexión JDBC para MySQL
                "root",  // Nombre de usuario de la base de datos (cambia según tu configuración)
                "ortigoza24" // Contraseña de la base de datos (cambia según tu configuración)
            );
